...
public class ListOrdersView extends javax.swing.JFrame implements OrderCreatedEventListener {
  ...
  private void loadOrders() {
    ...
    orders.forEach(order -> tableModel.addRow(new Object[] {order.getOrderNumber(), order.getSubtotal()}));
  ...
  private void initComponents() {
    ...
    }, new String[] {"Numero pedido", "subtotal"}) {
    ...
    layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup().addContainerGap()
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup().addComponent(createOrderButton).addGap(0, 0,
                                    Short.MAX_VALUE)))
                    .addContainerGap()));
    layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
            javax.swing.GroupLayout.Alignment.TRAILING,
            layout.createSequentialGroup().addGap(20, 20, 20).addComponent(createOrderButton)
